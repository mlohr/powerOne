---
description: "Define or update the product vision — conversational, multi-step process"
---
...
If the user hasn't already provided a product name, ask them:
...
The `# [Product Name]` heading at the top is required — this is what displays as the card title in the app.
