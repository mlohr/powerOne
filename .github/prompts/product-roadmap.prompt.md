---
description: "Create or update the product roadmap — break product into development sections"
---
...
Then ask: "Does this breakdown make sense? Would you like to adjust any sections or their order?"
...
**Next step:** Run `/data-model` to define the core entities and relationships in your product."
...
- **Sync from files** — Re-read the markdown files and confirm everything is in sync
