# PowerOne — Design Handoff

This folder contains everything needed to implement PowerOne, an outcome-driven OKR management tool.
...
**Sections in order:**
- `02-okr-hierarchy` — Core OKR browsing, filtering, and CRUD
- `03-programs` — Cross-entity strategic initiative management
- `04-metrics-and-progress` — Sprint metric updates
- `05-okr-rituals` — Ritual scheduling and facilitation
